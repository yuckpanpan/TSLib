...
if __name__ == '__main__':
    ...
    # data loader
    parser.add_argument('--data', type=str, required=True, default='windows_t0', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./dataset/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='14_14_with_Y_PV.npz', help='data file')
